...
BOARD_KERNEL_CMDLINE := androidboot.hardware=bacon user_debug=31 msm_rtb.filter=0x3F ehci-hcd.park=3 androidboot.selinux=permissive console=tty0 apparmor=0
